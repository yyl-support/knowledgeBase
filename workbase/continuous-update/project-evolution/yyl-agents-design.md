...
│         │                                           │
│  ┌──────┴───────┐  :51820      ┌────────────────┐  │
│  │  HTTP Server │◄───SSE───────│  浏览器 Web UI  │  │
│  │  (Hono)      │              └────────────────┘  │
│  └──────┬───────┘                                   │
│         │                                           │
│  ┌──────┴───────┐                                   │
│  │  SQLite DB   │  ◄─── better-sqlite3              │
│  │  memory.db   │  (知识索引 + 会话 + 消息)          │
│  └──────┬───────┘                                   │
│         │                                           │
│  ┌──────┴───────┐  localhost:51990                  │
│  │  TS 主进程   │───HTTP(token)──► ┌──────────────┐ │
...
```
┌──────────────────────────────────────────────────────────────┐
│  yyl-agents  ◉ connected            项目: backlog      ⚙ 设置 │
├────────────────┬────────────────────┬─────────────────────────┤
│   会话列表      │    知识库           │     消息总线             │
│   (左 1/4)     │    (中 2/4)        │     (右 1/4)            │
│                │                    │                         │
│ ┌────────────┐ │ ┌────────────────┐ │ ┌───────────────────┐  │
│ │ 新建会话    │ │ │ 搜索:[      ]  │ │ │ 发送给:[opencode▼] │  │
│ ├────────────┤ │ │ 🔍语义 📋全部  │ │ │                    │  │
│ │● #a1f2 活跃 │ │ │ 📄md ⚙过滤    │ │ │ 🤖 opencode 12:03  │  │
│ │  opencode   │ │ ├────────────────┤ │ │ "task done..."    │  │
│ │  3 任务待办  │ │ │ 2026-06-08    │ │ │                    │  │
│ ├────────────┤ │ │ api-redesign  │ │ │ 🤖 claude 12:01    │  │
│ │○ #b3d8 完成 │ │ │ 架构评审意见   │ │ │ "开始 code review" │  │
│ │  claude     │ │ │ ☁ 已同步  ✅  │ │ │                    │  │
│ │  已产出交接  │ │ ├────────────────┤ │ │ 📝 输入消息...     │  │
│ └────────────┘ │ │ 2026-06-07     │ │ │ [发送]             │  │
│                │ │ bugfix-502     │ │ └───────────────────┘  │
